    ...
    <div className="app-page-scroll pe-2">
      <div className="d-flex flex-column h-100 gap-4">
        ...
        <div className="row g-4 flex-grow-1" style={{ minHeight: 0 }}>
          <div className="col-lg-8 d-flex" style={{ minHeight: 0 }}>
            <div className="glass-panel d-flex flex-column w-100" style={{ minHeight: 0 }}>
              <div className="px-4 py-3 flex-shrink-0" style={{ borderBottom: '1px solid var(--border)' }}>
                <h5 className="mb-0 fw-bold" style={{ color: 'var(--text-main)' }}>Recent Activity</h5>
              </div>
              <div className="p-3 app-panel-scroll">
          ...
          <div className="col-lg-4 d-flex" style={{ minHeight: 0 }}>
            <div className="glass-panel d-flex flex-column w-100" style={{ minHeight: 0 }}>
